    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/' element={<Layout />}>
          ...
          <Route path='production/shift' element={<ServiceReceive />}/>
          <Route path='production/dispatch' element={<ServiceReceive />}/>
          <Route path='production/time-schedule' element={<ServiceReceive />}/>
          <Route path='production/dispatch-record' element={<ServiceReceive />}/>
          <Route path='production/dispatch-description' element={<ServiceReceive />}/>
          <Route path='production/job-status' element={<ServiceReceive />}/>
          <Route path='production/equipment-part' element={<EquipmentPart />} />
          <Route path='production/mr-sr-status' element={<ServiceReceive />}/>
          <Route path='engineering/sumary-report' element={<ServiceReceive />}/>
          <Route path='engineering/bill-of-material' element={<ServiceReceive />}/>
          <Route path='engineering/bom-dimension' element={<ServiceReceive />}/>
          <Route path='engineering/drawing' element={<ServiceReceive />}/>
