...
import AksiFormatter from '../components/material_request/AksiFormatter'
...
import ModalTambah from '../components/material_request/ModalTambah'
import ModalEdit from '../components/material_request/ModalEdit'
import ModalDetail from '../components/material_request/ModalDetail'
import ModalRemove from '../components/material_request/ModalRemove'
...
const MaterialRequest = () => {
    console.log('====================================')
    console.log('page material_request')
    console.log('====================================')
...
export default memo(MaterialRequest)
