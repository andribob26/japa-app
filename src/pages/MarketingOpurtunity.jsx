...
import AksiFormatter from '../components/marketing_opurtunity/AksiFormatter'
...
import ModalTambah from '../components/marketing_opurtunity/ModalTambah'
import ModalEdit from '../components/marketing_opurtunity/ModalEdit'
import ModalDetail from '../components/marketing_opurtunity/ModalDetail'
import ModalRemove from '../components/marketing_opurtunity/ModalRemove'
...
const MarketingOpurtunity = () => {
    console.log('====================================')
    console.log('page marketing_opurtunity')
    console.log('====================================')
...
export default memo(MarketingOpurtunity)
