...
import AksiFormatter from '../components/spj_cash_advance/AksiFormatter'
...
import ModalTambah from '../components/spj_cash_advance/ModalTambah'
import ModalEdit from '../components/spj_cash_advance/ModalEdit'
import ModalDetail from '../components/spj_cash_advance/ModalDetail'
import ModalRemove from '../components/spj_cash_advance/ModalRemove'
...
const SpjCashAdvance = () => {
    console.log('====================================')
    console.log('page spj_cash_advance')
    console.log('====================================')
...
export default memo(SpjCashAdvance)
