...
import AksiFormatter from '../components/dispatch_record/AksiFormatter'
...
import ModalTambah from '../components/dispatch_record/ModalTambah'
import ModalEdit from '../components/dispatch_record/ModalEdit'
import ModalDetail from '../components/dispatch_record/ModalDetail'
import ModalRemove from '../components/dispatch_record/ModalRemove'
...
const DispatchRecord = () => {
    console.log('====================================')
    console.log('page dispatch_record')
    console.log('====================================')
...
export default memo(DispatchRecord)
