...
const ModalTambah = ({ val, token }) => {
  ...
  const { success, isLoading, type } = useSelector(state => state.quotationSlice.resQuotation)
  const { data, limit, totalData, currentPage, isLoading: isLoadingCustomer } = useSelector(
    state => state.customerSlice.dataCustomer
  )
  ...
  const removeListQueDesk = (idx) => {
    formik.setValues((val) => ({
      ...val,
      quodesk: [...val.quodesk.slice(0, idx), ...val.quodesk.slice(idx + 1, val.quodesk.length)]
    }))
  }
            ...
            <div className='modal-header tw-flex tw-flex-shrink-0 tw-items-center tw-justify-between tw-py-2 tw-px-6 tw-border-b tw-border-gray-200 tw-rounded-t'>
              ...
              <ul class="nav nav-tabs tw-flex tw-flex-row tw-flex-wrap tw-list-none tw-border-b-0 tw-pl-0" id="tabs-tab"
                ...
                <li class="nav-item" role="presentation">
                  <a href="#tabs-quo" class="nav-link tw-block tw-font-bold tw-text-xs tw-leading-tight tw-border-x-0 tw-border-t-0 tw-border-transparent tw-px-3 tw-py-2 tw-my-0 hover:tw-border-transparent hover:tw-bg-gray-100 focus:tw-border-transparent active"
                    id="tabs-quo-tab"
                    data-bs-toggle="pill"
                ...
                <li class="nav-item" role="presentation">
                  <a href="#tabs-detail" class="nav-link tw-block tw-font-bold tw-text-xs tw-leading-tight tw-border-x-0 tw-border-t-0 tw-border-transparent tw-px-3 tw-py-2 tw-my-0 hover:tw-border-transparent hover:tw-bg-gray-100 focus:tw-border-transparent"
                    id="tabs-detail-tab"
                    data-bs-toggle="pill"
            ...
            <div ref={modalRef} className='modal-body tw-relative tw-py-2 tw-px-6'>
              ...
              <form>
                <div class="tab-content" id="tabs-tabContent">
                  <div class="tab-pane fade show active" id="tabs-quo" role="tabpanel" aria-labelledby="tabs-quo-tab">
                      ...
                      <div className='tw-form-group tw-mb-2 tw-w-1/2'>
                        ...
                        <div className='tw-relative'>
                          <input
                            ...
                            type='date'
                            className={`${formik.touched.tanggal_quo && formik.errors.tanggal_quo
                              ? `tw-border-red-500`
                              : `tw-border-gray-300`
                          ...
                          />
                          {
                            formik.touched.tanggal_quo && formik.errors.tanggal_quo && <p className='tw-absolute tw-text-red-500 -tw-top-4 tw-right-0 tw-m-0 tw-text-xs'>
                    ...
                    <div className='tw-form-group tw-mb-2'>
                      ...
                      <div className='tw-relative'>
                        ...
                        {
                          formik.touched.cus_id && formik.errors.cus_id && <p className='tw-absolute tw-text-red-500 -tw-top-4 tw-right-0 tw-m-0 tw-text-xs'>
                    ...
                    <div className='tw-form-group tw-mb-2'>
                      ...
                      <div className='tw-relative'>
                        <input
                          ...
                          disabled
                          type='text'
                          className={`${formik.touched.address && formik.errors.address ? `tw-border-red-500` : `tw-border-gray-300`} tw-form-control tw-block tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-normal  tw-text-gray-700 tw-bg-gray-100 tw-bg-clip-padding tw-border tw-border-solid tw-rounded tw-transition tw-ease-in-out tw-m-0 focus:tw-text-gray-700 focus:tw-bg-white focus:tw-border-sky-600 focus:tw-outline-none`}
                          id='address'
                          placeholder='Adress'
                        />
                        {
                          formik.touched.address && formik.errors.address && <p className='tw-absolute tw-text-red-500 -tw-top-4 tw-right-0 tw-m-0 tw-text-xs'>
                    ...
                    <div className='tw-form-group tw-mb-2'>
                      ...
                      <div className='tw-relative'>
                        <input
                          ...
                          disabled
                          type='text'
                          className={`${formik.touched.city && formik.errors.city ? `tw-border-red-500` : `tw-border-gray-300`} tw-form-control tw-block tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-normal  tw-text-gray-700 tw-bg-gray-100 tw-bg-clip-padding tw-border tw-border-solid tw-rounded tw-transition tw-ease-in-out tw-m-0 focus:tw-text-gray-700 focus:tw-bg-white focus:tw-border-sky-600 focus:tw-outline-none`}
                          id='city'
                          placeholder='City'
                        />
                        {
                          formik.touched.city && formik.errors.city && <p className='tw-absolute tw-text-red-500 -tw-top-4 tw-right-0 tw-m-0 tw-text-xs'>
                            {formik.errors.city}
                          </p>
                        }
                      </div>
                    ...
                    <div className='tw-form-group tw-mb-2'>
                      ...
                      <div className='tw-relative'>
                        ...
                        {
                          formik.touched.contact && formik.errors.contact && <p className='tw-absolute tw-text-red-500 -tw-top-4 tw-right-0 tw-m-0 tw-text-xs'>
                  ...
                  <div class="tab-pane fade" id="tabs-detail" role="tabpanel" aria-labelledby="tabs-detail-tab">
                      ...
                      <div className='tw-form-group tw-mb-2 tw-w-1/3'>
                        ...
                        <div className='tw-relative'>
                          <input
                            ...
                            type='text'
                            className={`${formikDesk.touched.item && formikDesk.errors.item ? `tw-border-red-500` : `tw-border-gray-300`} tw-form-control tw-block tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-normal  tw-text-gray-700 tw-bg-white tw-bg-clip-padding tw-border tw-border-solid tw-rounded tw-transition tw-ease-in-out tw-m-0 focus:tw-text-gray-700 focus:tw-bg-white focus:tw-border-sky-600 focus:tw-outline-none`}
                            id='item'
                            name="item"
                            placeholder='Item'
                          />
                      ...
                      <div className='tw-form-group tw-mb-2 tw-w-1/3'>
                        ...
                        <div className='tw-relative'>
                          <input
                            ...
                            type='number'
                            className={`${formikDesk.touched.vol && formikDesk.errors.vol ? `tw-border-red-500` : `tw-border-gray-300`} tw-form-control tw-block tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-normal  tw-text-gray-700 tw-bg-white tw-bg-clip-padding tw-border tw-border-solid tw-rounded tw-transition tw-ease-in-out tw-m-0 focus:tw-text-gray-700 focus:tw-bg-white focus:tw-border-sky-600 focus:tw-outline-none`}
                            id='vol'
                            name="vol"
                            placeholder='Volume'
                          />
                      ...
                      <div className='tw-form-group tw-mb-2 tw-w-1/3'>
                        ...
                        <div className='tw-relative'>
                          <input
                            ...
                            type='text'
                            className={`${formikDesk.touched.unit && formikDesk.errors.unit ? `tw-border-red-500` : `tw-border-gray-300`} tw-form-control tw-block tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-normal  tw-text-gray-700 tw-bg-white tw-bg-clip-padding tw-border tw-border-solid tw-rounded tw-transition tw-ease-in-out tw-m-0 focus:tw-text-gray-700 focus:tw-bg-white focus:tw-border-sky-600 focus:tw-outline-none`}
                            id='unit'
                            name="unit"
                            placeholder='Unit'
                          />
